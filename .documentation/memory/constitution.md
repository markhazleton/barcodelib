# BarCodeSpark Constitution

## Project Profile

- Project name: BarCodeSpark
- Technology stack: .NET / Microsoft
- Default core principles: backward compatibility, explicit scope, ownership boundaries, simplicity, platform parity, markdown quality, and genuine behavior-focused fixes.
